...
5. **Ronde 6 — afronding (LAATSTE).**
   ...
   - 🚧 **6c UI (frontend) — IN UITVOERING.** Stack: **React 19 + Zustand + Tauri**. ISSO 53 onverwarmd/U-velden (`Isso53RoomFunctionCell.tsx:156-196`: isUnheated/unheatedFactor/infiltrationReductionZ) zijn AL compleet — geen werk.
     ...
     - ~~**Veld-rename `f_rh`→P / `accumulating_area`→A_g**~~ ✅ zie Fase 1 hierboven.
